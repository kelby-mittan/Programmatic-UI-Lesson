...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    // iOS 13 now has the scene delegate, this is where the window property is
    // in order to setup your programmatic UI code you must set the rootViewController property of the window
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        // Steps in configuring programmatic UI in the scene delegate
